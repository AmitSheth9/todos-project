...
app.post('/api/animals', async(req, res) => {
  try {
    const data = await client.query(`Insert into animals (todo, completed, owner_id)
    VALUES ($1, $2, $3)`, [req.body.todo, false, req.userId]);
...
app.put('/api/animals/:id', async(req, res) => {
  try {
    const data = await client.query(`UPDATE animals
    SET completed = $1
